...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tutorapp', '0013_roles_remove_student_user_remove_teacher_user_users_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='course_category', to='tutorapp.category')),
                ('teacher_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_courses', to='tutorapp.teacher')),
            ],
        ),
